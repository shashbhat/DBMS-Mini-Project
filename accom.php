...
<!--                            main body goes here -->
    ...
    <div class="container mt-2" style="background-color:#e9e9e9;padding:20px;border-radius:5px">
        <div class="row">
            <div class="col-md-12">
                <a href='accominsert.html' class='btn btn-primary' style="float:left" >Insert</a>
            </div>
                <?php
    ...
    $result = mysqli_query($con,"SELECT * FROM accom");
       
           echo "<div class='container' style='padding:5px;background-color:white;margin-top:30px;'>";
     echo "<table  id='rest-tab' class='table table-light table-hover'><thead class='thead-light'><tr><th>Image</th><th>Name</th><th>Price</th><th>Location</th><th>ID</th><th>Delete</th><th>Edit</th><th>Book</th></tr></thead><tbody>";
    while($row = mysqli_fetch_array($result))
      {
      echo "<tr><td><img src=".$row['Image']. " height='64' width='64'></td><td>".$row['Name'] . "</td><td> " . $row['Price']. "</td><td> " . $row['Location']. "</td><td> " .$row['Id']."</td><td><a href='accomdelete.php?Id=".$row['Id']."'>Delete<i class='fa fa-trash '></i></a></td><td><a href='accomedit.html'>Edit</a></td><td><a href='#book'>Book</a></td></tr>"; //these are the fields that you have stored in your database table employee
				...
				<div class="col fill_height">
					...
					<div class="search_panel active">
						<form action="#" id="search_form_1" class="search_panel_content d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start">
                           ...
                           <button class="button search_button" onclick="doThis()">Book<span></span><span></span><span></span></button>
